...
return {
  ...
  keys = {
    ...
    { "<space>l", ":lua require 'fzf-lua'.grep_curbuf()<cr>", desc = "[l]ines in buffer" },
    { "<space>L", ":lua require 'fzf-lua'.blines()<cr>", desc = "[l]ines in buffer (fuzzy)" },
    {
      "<space>n",
    ...
    { "<leader>W", ":lua require 'fzf-lua'.grep_cWORD()<cr>", desc = "find current WORD" },
    { "<space>o", ":lua require 'fzf-lua'.old_files()<cr>", desc = "[o]ld files (recently used)" },
